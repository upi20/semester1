...
int main(){
	...
	if(totalharga >= 80000){
		...
		else if(totalharga >= 90000 && totalharga < 100000 ){
			discount = 15;
		}
		else if(totalharga >= 80000 && totalharga < 90000 ){
			discount = 10;
		}
		sovenir = "Payung";
	}
	else if(totalharga < 80000 ){
		if(totalharga >= 70000 && totalharga < 80000 ){
			discount = 5;
		}
		else if(totalharga >= 60000 && totalharga < 70000 ){
			discount = 2.5;
		}
		else if(totalharga >  50000 && totalharga < 60000 ){
			discount = 1;
		}
